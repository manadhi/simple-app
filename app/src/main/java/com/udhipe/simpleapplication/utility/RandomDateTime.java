...
public class RandomDateTime {
    public static void main(String[] args) {
        ...
        int year = RandomDateTime.randBetween(2020, 2020);// Here you can set Range of years you need
        int month = RandomDateTime.randBetween(0, 11);
        int hour = RandomDateTime.randBetween(0, 23); //Hours will be displayed in between 9 to 22
